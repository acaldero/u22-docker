...
#
#  Copyright 2019-2022 Saul Alonso Monsalve, Felix Garcia Carballeira, Jose Rivadeneira Lopez-Bravo, Alejandro Calderon Mateos,
#
#  This file is part of U22 proyect.
#
#  U22 is free software: you can redistribute it and/or modify
...
do
	...
	case $arg_i in
	     build)
		# Check params
		if [ ! -f u22-dockerfile ]; then
		    echo ": The u22-dockerfile file is not found."
		...
		docker image build -t u22 -f u22-dockerfile .
	     ;;
		...
		docker container exec -it $CNAME     \
	     ...
	     help)
		echo ""
		echo "  Ubuntu 22.04 on docker (v2.1) "
		echo " -------------------------------"
		echo ""
		echo "  Usage: $0 <action> [<options>]"
		echo ""
		echo "  : First time, and each time u22-dockerfile is update, please execute:"
		echo "        $0 build"
		echo ""
		...
		echo ""
		echo "  : Available option to uninstall u22-docker (remove images + containers):"
		echo "        $0 cleanup"
		echo ""
	     ;;
